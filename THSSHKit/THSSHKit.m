...
const char *keyfile1 = "/Users/thgit/.ssh/id_rsa.pub";
const char *keyfile2 = "/Users/thgit/.ssh/id_rsa";
const char *username = "";
const char *password = "";
...
+ (BOOL)createRemoteTunnelWithServerIP:(NSString *)serverIP username:(NSString *)userName password:(NSString *)password remoteListenPort:(int)remoteListenPort forwardIP:(NSString *)forwadIP forwardPort:(int)forwardPort {
    return NO;
}
